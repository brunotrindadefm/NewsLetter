...
function App() {
  return (
    <div className="bg-slate-900 min-h-screen w-full flex flex-col items-center justify-center">
      ...
      <p className="text-white">Assine nosso serviço</p>
      <div className="w-96 mt-4 bg-stone-200 px-4 py-5 rounded-lg">
        <Form />
      </div>
      <p className="text-slate-100 text-xs w-96 mt-2 text-center">Ao se inscrever você passará a receber nossos emails, com as melhores dicas, novidades e ofertas</p>
    </div>
  );
}
